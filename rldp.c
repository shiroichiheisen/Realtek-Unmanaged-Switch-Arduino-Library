...
static rtk_api_ret_t _rtk_rldp_portConfig_get(rtk_port_t port, rtk_rldp_portConfig_t *pPortConfig)
{
    ...
    {
        pPortConfig->tx_enable = RTK_ENABLED;
    }
    else
    {
        pPortConfig->tx_enable = RTK_DISABLED;
    }
...
{
    return _rtk_rldp_config_set(pConfig);
}
...
{
    return _rtk_rldp_config_get(pConfig);
}
...
{
    return _rtk_rldp_portConfig_set(port, pPortConfig);
...
{
    return _rtk_rldp_portConfig_get(port, pPortConfig);
...
{
    return _rtk_rldp_status_get(pStatus);
...
{
    return _rtk_rldp_portStatus_get(port, pPortStatus);
}
...
{
    return _rtk_rldp_portStatus_set(port, pPortStatus);
}
...
{
    return _rtk_rldp_portLoopPair_get(port, pPortmask);
}
