...
extern rtk_api_ret_t rtk_port_phyStatus_get_uint8(uint8_t port, uint8_t *pLinkStatus, uint8_t *pSpeed, uint8_t *pDuplex);
...
extern rtk_api_ret_t rtk_port_sgmiiLinkStatus_get_uint8(rtk_uint8 port, rtk_uint8 *pSignalDetect, rtk_uint8 *pSync, rtk_uint8 *pLink);
