...
static rtk_api_ret_t _rtk_qos_init(rtk_queue_num_t queueNum)
{
    ...
    RTK_SCAN_ALL_PHY_PORTMASK(port)
    {
        if ((retVal = rtl8367c_setAsicRemarkingDot1pAbility(port, RTK_DISABLED)) != RT_ERR_OK)
            return retVal;
    }

    /*Disable DSCP Remarking*/
    if ((retVal = rtl8367c_setAsicRemarkingDscpAbility(RTK_DISABLED)) != RT_ERR_OK)
        return retVal;
...
{
    return _rtk_qos_priSel_set(index, pPriDec);
}
...
{
    return _rtk_qos_priSel_get(index, pPriDec);
}
...
{
    return _rtk_qos_1pPriRemap_set(dot1p_pri, int_pri);
}
...
{
    return _rtk_qos_1pPriRemap_get(dot1p_pri, pInt_pri);
}
...
{
    return _rtk_qos_dscpPriRemap_set(dscp, int_pri);
}
...
{
    return _rtk_qos_dscpPriRemap_get(dscp, pInt_pri);
}
...
{
    return _rtk_qos_portPri_set(port, int_pri);
}
...
{
    return _rtk_qos_portPri_get(port, pInt_pri);
}
...
{
    return _rtk_qos_queueNum_set(port, queue_num);
}
...
{
    return _rtk_qos_queueNum_get(port, pQueue_num);
}
...
{
    return _rtk_qos_priMap_set(queue_num, pPri2qid);
}
...
{
    return _rtk_qos_priMap_get(queue_num, pPri2qid);
}
...
{
    return _rtk_qos_schedulingQueue_set(port, pQweights);
}
...
{
    return _rtk_qos_schedulingQueue_get(port, pQweights);
}
...
{
    return _rtk_qos_1pRemarkEnable_set(port, enable);
}
...
{
    return _rtk_qos_1pRemarkEnable_get(port, pEnable);
}
...
{
    return _rtk_qos_1pRemark_set(int_pri, dot1p_pri);
}
...
{
    return _rtk_qos_1pRemark_get(int_pri, pDot1p_pri);
}
...
{
    return _rtk_qos_1pRemarkSrcSel_set(type);
}
...
{
    return _rtk_qos_1pRemarkSrcSel_get(pType);
}
...
{
    return _rtk_qos_dscpRemarkEnable_set(port, enable);
}
...
{
    return _rtk_qos_dscpRemarkEnable_get(port, pEnable);
}
...
{
    return _rtk_qos_dscpRemark_set(int_pri, dscp);
}
...
{
    return _rtk_qos_dscpRemark_get(int_pri, pDscp);
}
...
{
    return _rtk_qos_dscpRemarkSrcSel_set(type);
}
...
{
    return _rtk_qos_dscpRemarkSrcSel_get(pType);
}
...
{
    return _rtk_qos_dscpRemark2Dscp_set(dscp, rmkDscp);
}
...
{
    return _rtk_qos_dscpRemark2Dscp_get(dscp, pDscp);
}
...
{
    return _rtk_qos_portPriSelIndex_set(port, index);
}
...
{
    return _rtk_qos_portPriSelIndex_get(port, pIndex);
}
