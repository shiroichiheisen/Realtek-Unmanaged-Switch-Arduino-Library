...
static rtk_api_ret_t _rtk_svlan_memberPortEntry_set(rtk_vlan_t svid, rtk_svlan_memberCfg_t *pSvlan_cfg)
{
    ...
    if (pSvlan_cfg->fiden > RTK_ENABLED)
    ...
    if (pSvlan_cfg->efiden > RTK_ENABLED)
        return RT_ERR_ENABLE;
...
{
    return _rtk_svlan_servicePort_add(port);
}
/* Function Name:
...
{
    return _rtk_svlan_servicePort_get(pSvlan_portmask);
}
/* Function Name:
...
{
    return _rtk_svlan_servicePort_del(port);
}
...
{
    return _rtk_svlan_tpidEntry_set(svlan_tag_id);
}
/* Function Name:
...
{
    return _rtk_svlan_tpidEntry_get(pSvlan_tag_id);
}
/* Function Name:
...
{
    return _rtk_svlan_priorityRef_set(ref);
}
/* Function Name:
...
{
    return _rtk_svlan_priorityRef_get(pRef);
}
/* Function Name:
...
{
    return _rtk_svlan_memberPortEntry_set(svid, pSvlan_cfg);
}
/* Function Name:
...
{
    return _rtk_svlan_memberPortEntry_get(svid, pSvlan_cfg);
}
/* Function Name:
...
{
    return _rtk_svlan_memberPortEntry_adv_set(idx, pSvlan_cfg);
}
/* Function Name:
...
{
    return _rtk_svlan_memberPortEntry_adv_get(idx, pSvlan_cfg);
}
/* Function Name:
...
rtk_api_ret_t rtk_svlan_defaultSvlan_set(rtk_port_t port, rtk_vlan_t svid)
{
    ...
    return _rtk_svlan_defaultSvlan_set(port, svid);
}
/* Function Name:
...
rtk_api_ret_t rtk_svlan_defaultSvlan_get(rtk_port_t port, rtk_vlan_t *pSvid)
{
    ...
    return _rtk_svlan_defaultSvlan_get(port, pSvid);
}
/* Function Name:
 *      rtk_svlan_c2s_add
 * Description:
...
rtk_api_ret_t rtk_svlan_c2s_add(rtk_vlan_t vid, rtk_port_t src_port, rtk_vlan_t svid)
{
    ...
    return _rtk_svlan_c2s_add(vid, src_port, svid);
}
/* Function Name:
 *      rtk_svlan_c2s_del
 * Description:
...
{
    return _rtk_svlan_c2s_del(vid, src_port);
}
/* Function Name:
 *      rtk_svlan_c2s_get
 * Description:
...
{
    return _rtk_svlan_c2s_get(vid, src_port, pSvid);
}
/* Function Name:
...
{
    return _rtk_svlan_untag_action_set(action, svid);
}
/* Function Name:
...
{
    return _rtk_svlan_untag_action_get(pAction, pSvid);
}
/* Function Name:
...
{
    return _rtk_svlan_unmatch_action_set(action, svid);
}
/* Function Name:
...
{
    return _rtk_svlan_unmatch_action_get(pAction, pSvid);
}
/* Function Name:
...
{
    return _rtk_svlan_unassign_action_set(action);
}
/* Function Name:
...
{
    return _rtk_svlan_unassign_action_get(pAction);
}
/* Function Name:
...
{
    return _rtk_svlan_dmac_vidsel_set(port, enable);
}
/* Function Name:
...
{
    return _rtk_svlan_dmac_vidsel_get(port, pEnable);
}
/* Function Name:
...
{
    return _rtk_svlan_ipmc2s_add(ipmc, ipmcMsk, svid);
}
/* Function Name:
...
{
    return _rtk_svlan_ipmc2s_del(ipmc, ipmcMsk);
}
/* Function Name:
...
{
    return _rtk_svlan_ipmc2s_get(ipmc, ipmcMsk, pSvid);
}
/* Function Name:
...
{
    return _rtk_svlan_l2mc2s_add(mac, macMsk, svid);
}
...
{
    return _rtk_svlan_l2mc2s_del(mac, macMsk);
}
...
{
    return _rtk_svlan_l2mc2s_get(mac, macMsk, pSvid);
}
...
{
    return _rtk_svlan_sp2c_add(svid, dst_port, cvid);
}
...
{
    return _rtk_svlan_sp2c_get(svid, dst_port, pCvid);
}
...
{
    return _rtk_svlan_sp2c_del(svid, dst_port);
}
...
{
    return _rtk_svlan_lookupType_set(type);
}
...
{
    return _rtk_svlan_lookupType_get(pType);
}
...
{
    return _rtk_svlan_trapPri_set(priority);
...
{
    return _rtk_svlan_trapPri_get(pPriority);
} /* end of rtk_svlan_trapPri_get */
