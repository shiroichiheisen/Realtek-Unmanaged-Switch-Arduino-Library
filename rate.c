...
{
    return _rtk_rate_shareMeter_set(index, type, rate, ifg_include);
}
...
{
    return _rtk_rate_shareMeter_get(index, pType, pRate, pIfg_include);
}
...
{
    return _rtk_rate_shareMeterBucket_set(index, bucket_size);
}
...
{
    return _rtk_rate_shareMeterBucket_get(index, pBucket_size);
}
...
{
    return _rtk_rate_igrBandwidthCtrlRate_set(port, rate, ifg_include, fc_enable);
}
...
{
    return _rtk_rate_igrBandwidthCtrlRate_get(port, pRate, pIfg_include, pFc_enable);
}
...
{
    return _rtk_rate_egrBandwidthCtrlRate_set(port, rate, ifg_include);
}
...
{
    return _rtk_rate_egrBandwidthCtrlRate_get(port, pRate, pIfg_include);
}
...
{
    return _rtk_rate_egrQueueBwCtrlEnable_get(port, queue, pEnable);
}
...
{
    return _rtk_rate_egrQueueBwCtrlEnable_set(port, queue, enable);
}
...
{
    return _rtk_rate_egrQueueBwCtrlRate_get(port, queue, pIndex);
}
...
{
    return _rtk_rate_egrQueueBwCtrlRate_set(port, queue, index);
}
