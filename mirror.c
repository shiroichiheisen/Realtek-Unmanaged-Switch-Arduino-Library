...
{
    return _rtk_mirror_portBased_set(mirroring_port, pMirrored_rx_portmask, pMirrored_tx_portmask);
}
...
{
    return _rtk_mirror_portBased_get(pMirroring_port, pMirrored_rx_portmask, pMirrored_tx_portmask);
}
...
{
    return _rtk_mirror_portIso_set(enable);
}
...
{
    return _rtk_mirror_portIso_get(pEnable);
}
...
{
    return _rtk_mirror_vlanLeaky_set(txenable, rxenable);
}
...
{
    return _rtk_mirror_vlanLeaky_get(pTxenable, pRxenable);
}
...
{
    return _rtk_mirror_isolationLeaky_set(txenable, rxenable);
}
...
{
    return _rtk_mirror_isolationLeaky_get(pTxenable, pRxenable);
}
...
{
    return _rtk_mirror_keep_set(mode);
}
...
{
    return _rtk_mirror_keep_get(pMode);
}
...
{
    return _rtk_mirror_override_set(rxMirror, txMirror, aclMirror);
}
...
{
    return _rtk_mirror_override_get(pRxMirror, pTxMirror, pAclMirror);
}
