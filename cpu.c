...
{
    return _rtk_cpu_enable_set(enable);
}
...
{
    return _rtk_cpu_enable_get(pEnable);
}
...
{
    return _rtk_cpu_tagPort_set(port, mode);
}
...
{
    return _rtk_cpu_tagPort_get(pPort, pMode);
}
...
{
    return _rtk_cpu_awarePort_set(pPortmask);
}
...
{
    return _rtk_cpu_awarePort_get(pPortmask);
}
...
{
    return _rtk_cpu_tagPosition_set(position);
}
...
{
    return _rtk_cpu_tagPosition_get(pPosition);
}
...
{
    return _rtk_cpu_tagLength_set(length);
}
...
{
    return _rtk_cpu_tagLength_get(pLength);
}
...
{
    return _rtk_cpu_priRemap_set(int_pri, new_pri);
}
...
{
    return _rtk_cpu_priRemap_get(int_pri, pNew_pri);
}
...
{
    return _rtk_cpu_acceptLength_set(length);
}
...
{
    return _rtk_cpu_acceptLength_get(pLength);
}
