...
{
    return _rtk_ptp_tpid_set(outerId, innerId);
}
...
{
    return _rtk_ptp_tpid_get(pOuterId, pInnerId);
}
...
{
    return _rtk_ptp_refTime_set(timeStamp);
}
...
{
    return _rtk_ptp_refTime_get(pTimeStamp);
}
...
{
    return _rtk_ptp_refTimeAdjust_set(sign, timeStamp);
}
...
{
    return _rtk_ptp_refTimeEnable_set(enable);
}
...
{
    return _rtk_ptp_refTimeEnable_get(pEnable);
}
...
{
    return _rtk_ptp_portEnable_set(port, enable);
}
...
{
    return _rtk_ptp_portEnable_get(port, pEnable);
}
...
{
    return _rtk_ptp_portTimestamp_get(port, type, pInfo);
}
...
{
    return _rtk_ptp_intControl_set(type, enable);
}
...
{
    return _rtk_ptp_intControl_get(type, pEnable);
}
...
{
    return _rtk_ptp_intStatus_get(pStatusMask);
}
...
{
    return _rtk_ptp_portIntStatus_set(port, statusMask);
}
...
{
    return _rtk_ptp_portIntStatus_get(port, pStatusMask);
}
...
{
    return _rtk_ptp_portTrap_set(port, enable);
}
...
{
    return _rtk_ptp_portTrap_get(port, pEnable);
}
