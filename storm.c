...
{
    return _rtk_rate_stormControlMeterIdx_set(port, stormType, index);
}
...
{
    return _rtk_rate_stormControlMeterIdx_get(port, stormType, pIndex);
}
...
{
    return _rtk_rate_stormControlPortEnable_set(port, stormType, enable);
}
...
{
    return _rtk_rate_stormControlPortEnable_get(port, stormType, pEnable);
}
...
{
    return _rtk_storm_bypass_set(type, enable);
}
...
{
    return _rtk_storm_bypass_get(type, pEnable);
}
...
{
    return _rtk_rate_stormControlExtPortmask_set(pPortmask);
}
...
{
    return _rtk_rate_stormControlExtPortmask_get(pPortmask);
}
...
{
    return _rtk_rate_stormControlExtEnable_set(stormType, enable);
}
...
{
    return _rtk_rate_stormControlExtEnable_get(stormType, pEnable);
}
...
{
    return _rtk_rate_stormControlExtMeterIdx_set(stormType, index);
}
...
{
    return _rtk_rate_stormControlExtMeterIdx_get(stormType, pIndex);
}
