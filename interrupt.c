...
{
    return _rtk_int_polarity_set(type);
}
...
{
    return _rtk_int_polarity_get(pType);
}
...
{
    return _rtk_int_control_set(type, enable);
}
...
{
    return _rtk_int_control_get(type, pEnable);
}
...
{
    return _rtk_int_status_set(pStatusMask);
}
...
{
    return _rtk_int_status_get(pStatusMask);
}
...
{
    return _rtk_int_advanceInfo_get(adv_type, pInfo);
}
