...
{
    return _rtk_leaky_vlan_set(type, enable);
}
...
{
    return _rtk_leaky_vlan_get(type, pEnable);
}
...
{
    return _rtk_leaky_portIsolation_set(type, enable);
}
...
{
    return _rtk_leaky_portIsolation_get(type, pEnable);
}
