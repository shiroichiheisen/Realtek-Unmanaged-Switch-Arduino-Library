...
{
    return _rtk_dot1x_unauthPacketOper_set(port, unauth_action);
}
...
{
    return _rtk_dot1x_unauthPacketOper_get(port, pUnauth_action);
}
...
{
    return _rtk_dot1x_eapolFrame2CpuEnable_set(enable);
}
...
{
    return _rtk_dot1x_eapolFrame2CpuEnable_get(pEnable);
}
...
{
    return _rtk_dot1x_portBasedEnable_set(port, enable);
}
...
{
    return _rtk_dot1x_portBasedEnable_get(port, pEnable);
}
...
{
    return _rtk_dot1x_portBasedAuthStatus_set(port, port_auth);
}
...
{
    return _rtk_dot1x_portBasedAuthStatus_get(port, pPort_auth);
}
...
{
    return _rtk_dot1x_portBasedDirection_set(port, port_direction);
}
...
{
    return _rtk_dot1x_portBasedDirection_get(port, pPort_direction);
}
...
{
    return _rtk_dot1x_macBasedEnable_set(port, enable);
}
...
{
    return _rtk_dot1x_macBasedEnable_get(port, pEnable);
}
...
{
    return _rtk_dot1x_macBasedAuthMac_add(port, pAuth_mac, fid);
}
...
{
    return _rtk_dot1x_macBasedAuthMac_del(port, pAuth_mac, fid);
}
...
{
    return _rtk_dot1x_macBasedDirection_set(mac_direction);
}
...
{
    return _rtk_dot1x_macBasedDirection_get(pMac_direction);
}
...
{
    return _rtk_dot1x_guestVlan_set(vid);
}
...
{
    return _rtk_dot1x_guestVlan_get(pVid);
}
...
{
    return _rtk_dot1x_guestVlan2Auth_set(enable);
}
...
{
    return _rtk_dot1x_guestVlan2Auth_get(pEnable);
}
