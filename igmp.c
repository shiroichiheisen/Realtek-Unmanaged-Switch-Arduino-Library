...
static rtk_api_ret_t _rtk_igmp_init(void)
{
    ...
    if ((retVal = rtl8367c_setAsicIGMPFastLeaveEn(RTK_ENABLED)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsicIGMPReportLeaveFlood(1)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsicIgmp(RTK_ENABLED)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_igmp_fastLeave_get(rtk_enable_t *pState)
{
    ...
    *pState = ((fast_leave == 1) ? RTK_ENABLED : RTK_DISABLED);
    return RT_ERR_OK;
}
...
static rtk_api_ret_t _rtk_igmp_dynamicRouterPort_get(rtk_igmp_dynamicRouterPort_t *pDynamicRouterPort)
{
    ...
    {
        pDynamicRouterPort->dynamicRouterPort0Valid = RTK_DISABLED;
        pDynamicRouterPort->dynamicRouterPort0 = 0;
        pDynamicRouterPort->dynamicRouterPort0Timer = 0;
    }
    else
    {
        pDynamicRouterPort->dynamicRouterPort0Valid = RTK_ENABLED;
    ...
    if (port == RTL8367C_ROUTER_PORT_INVALID)
    {
        pDynamicRouterPort->dynamicRouterPort1Valid = RTK_DISABLED;
        pDynamicRouterPort->dynamicRouterPort1 = 0;
        pDynamicRouterPort->dynamicRouterPort1Timer = 0;
    }
    else
    {
        pDynamicRouterPort->dynamicRouterPort1Valid = RTK_ENABLED;
...
{
    return _rtk_igmp_state_set(enabled);
}
...
{
    return _rtk_igmp_state_get(pEnabled);
}
...
{
    return _rtk_igmp_static_router_port_set(pPortmask);
}
...
{
    return _rtk_igmp_static_router_port_get(pPortmask);
}
...
{
    return _rtk_igmp_protocol_set(port, protocol, action);
}
...
{
    return _rtk_igmp_protocol_get(port, protocol, pAction);
}
...
{
    return _rtk_igmp_fastLeave_set(state);
}
...
{
    return _rtk_igmp_fastLeave_get(pState);
}
...
{
    return _rtk_igmp_maxGroup_set(port, group);
}
...
{
    return _rtk_igmp_maxGroup_get(port, pGroup);
}
...
{
    return _rtk_igmp_currentGroup_get(port, pGroup);
}
...
{
    return _rtk_igmp_tableFullAction_set(action);
}
...
{
    return _rtk_igmp_tableFullAction_get(pAction);
}
...
{
    return _rtk_igmp_checksumErrorAction_set(action);
}
...
{
    return _rtk_igmp_checksumErrorAction_get(pAction);
}
...
{
    return _rtk_igmp_leaveTimer_set(timer);
}
...
{
    return _rtk_igmp_leaveTimer_get(pTimer);
}
...
{
    return _rtk_igmp_queryInterval_set(interval);
}
...
{
    return _rtk_igmp_queryInterval_get(pInterval);
}
...
{
    return _rtk_igmp_robustness_set(robustness);
}
...
{
    return _rtk_igmp_robustness_get(pRobustness);
}
...
{
    return _rtk_igmp_dynamicRouterPortAllow_set(pPortmask);
}
...
{
    return _rtk_igmp_dynamicRouterPortAllow_get(pPortmask);
}
...
{
    return _rtk_igmp_dynamicRouterPort_get(pDynamicRouterPort);
}
...
{
    return _rtk_igmp_suppressionEnable_set(reportSuppression, leaveSuppression);
}
...
{
    return _rtk_igmp_suppressionEnable_get(pReportSuppression, pLeaveSuppression);
}
...
{
    return _rtk_igmp_portRxPktEnable_set(port, pRxCfg);
}
...
{
    return _rtk_igmp_portRxPktEnable_get(port, pRxCfg);
}
...
{
    return _rtk_igmp_groupInfo_get(index, pGroup);
}
...
{
    return _rtk_igmp_ReportLeaveFwdAction_set(action);
}
...
{
    return _rtk_igmp_ReportLeaveFwdAction_get(pAction);
}
...
{
    return _rtk_igmp_dropLeaveZeroEnable_set(enabled);
}
...
{
    return _rtk_igmp_dropLeaveZeroEnable_get(pEnabled);
}
...
{
    return _rtk_igmp_bypassGroupRange_set(group, enabled);
}
...
{
    return _rtk_igmp_bypassGroupRange_get(group, pEnable);
}
