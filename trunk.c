...
static rtk_api_ret_t _rtk_trunk_trafficSeparate_set(rtk_trunk_group_t trk_gid, rtk_trunk_separateType_t separateType)
{
    ...
    enabled = (separateType == SEPARATE_FLOOD) ? RTK_ENABLED : RTK_DISABLED;
...
static rtk_api_ret_t _rtk_trunk_trafficSeparate_get(rtk_trunk_group_t trk_gid, rtk_trunk_separateType_t *pSeparateType)
{
    ...
    *pSeparateType = (enabled == RTK_ENABLED) ? SEPARATE_FLOOD : SEPARATE_NONE;
    return RT_ERR_OK;
}
...
{
    return _rtk_trunk_port_set(trk_gid, pTrunk_member_portmask);
}
...
{
    return _rtk_trunk_port_get(trk_gid, pTrunk_member_portmask);
}
...
{
    return _rtk_trunk_distributionAlgorithm_set(trk_gid, algo_bitmask);
}
...
{
    return _rtk_trunk_distributionAlgorithm_get(trk_gid, pAlgo_bitmask);
}
...
{
    return _rtk_trunk_trafficSeparate_set(trk_gid, separateType);
}
...
{
    return _rtk_trunk_trafficSeparate_get(trk_gid, pSeparateType);
}
...
{
    return _rtk_trunk_mode_set(mode);
}
...
{
    return _rtk_trunk_mode_get(pMode);
}
...
{
    return _rtk_trunk_trafficPause_set(trk_gid, enable);
}
...
{
    return _rtk_trunk_trafficPause_get(trk_gid, pEnable);
}
...
{
    return _rtk_trunk_hashMappingTable_set(trk_gid, pHash2Port_array);
}
...
{
    return _rtk_trunk_hashMappingTable_get(trk_gid, pHash2Port_array);
}
...
{
    return _rtk_trunk_portQueueEmpty_get(pEmpty_portmask);
}
