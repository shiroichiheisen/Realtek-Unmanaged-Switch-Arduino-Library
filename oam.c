...
{
    return _rtk_oam_state_set(enabled);
}
...
{
    return _rtk_oam_state_get(pEnabled);
}
...
{
    return _rtk_oam_parserAction_set(port, action);
}
...
{
    return _rtk_oam_parserAction_get(port, pAction);
}
...
{
    return _rtk_oam_multiplexerAction_set(port, action);
}
...
{
    return _rtk_oam_multiplexerAction_get(port, pAction);
}
