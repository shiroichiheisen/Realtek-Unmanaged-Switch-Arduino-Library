...
static rtk_api_ret_t _rtk_filter_igrAcl_cfg_del(rtk_filter_id_t filter_id)
{
    ...
    if ((ret = rtl8367c_setAsicAclAct(filter_id, &initAct)) != RT_ERR_OK)
        return ret;
    if ((ret = rtl8367c_setAsicAclNot(filter_id, RTK_DISABLED)) != RT_ERR_OK)
        return ret;
...
static rtk_api_ret_t _rtk_filter_igrAcl_cfg_delAll(void)
{
    ...
    for (i = 0; i < RTL8367C_ACLRULENO; i++)
    {
        if ((ret = rtl8367c_setAsicAclActCtrl(i, FILTER_ENACT_INIT_MASK)) != RT_ERR_OK)
            return ret;
        if ((ret = rtl8367c_setAsicAclNot(i, RTK_DISABLED)) != RT_ERR_OK)
            return ret;
    }
...
static rtk_api_ret_t _rtk_filter_igrAcl_cfg_get(rtk_filter_id_t filter_id, rtk_filter_cfg_raw_t *pFilter_cfg, rtk_filter_action_t *pAction)
{
    ...
    if (aclRule.valid == 0)
    {
        pFilter_cfg->valid = RTK_DISABLED;
        return RT_ERR_OK;
    }
...
{
    return _rtk_filter_igrAcl_init();
}
...
{
    return _rtk_filter_igrAcl_field_add(pFilter_cfg, pFilter_field);
}
...
{
    return _rtk_filter_igrAcl_cfg_add(filter_id, pFilter_cfg, pFilter_action, ruleNum);
}
...
{
    return _rtk_filter_igrAcl_cfg_del(filter_id);
}
...
{
    return _rtk_filter_igrAcl_cfg_delAll();
}
...
{
    return _rtk_filter_igrAcl_cfg_get(filter_id, pFilter_cfg, pAction);
}
...
{
    return _rtk_filter_igrAcl_unmatchAction_set(port, action);
}
...
{
    return _rtk_filter_igrAcl_unmatchAction_get(port, pAction);
}
...
{
    return _rtk_filter_igrAcl_state_set(port, state);
}
...
{
    return _rtk_filter_igrAcl_state_get(port, pState);
}
...
{
    return _rtk_filter_igrAcl_template_set(aclTemplate);
}
...
{
    return _rtk_filter_igrAcl_template_get(aclTemplate);
}
...
{
    return _rtk_filter_igrAcl_field_sel_set(index, format, offset);
}
...
{
    return _rtk_filter_igrAcl_field_sel_get(index, pFormat, pOffset);
}
...
{
    return _rtk_filter_iprange_set(index, type, upperIp, lowerIp);
}
...
{
    return _rtk_filter_iprange_get(index, pType, pUpperIp, pLowerIp);
}
...
{
    return _rtk_filter_vidrange_set(index, type, upperVid, lowerVid);
}
/* Function Name:
...
{
    return _rtk_filter_vidrange_get(index, pType, pUpperVid, pLowerVid);
}
/* Function Name:
...
{
    return _rtk_filter_portrange_set(index, type, upperPort, lowerPort);
}
/* Function Name:
...
{
    return _rtk_filter_portrange_get(index, pType, pUpperPort, pLowerPort);
}
/* Function Name:
...
{
    return _rtk_filter_igrAclPolarity_set(polarity);
}
/* Function Name:
...
{
    return _rtk_filter_igrAclPolarity_get(pPolarity);
}
