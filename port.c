...
static rtk_api_ret_t _rtk_port_phyStatus_get_uint8(uint8_t port, uint8_t *pLinkStatus, uint8_t *pSpeed, uint8_t *pDuplex)
{
    rtk_api_ret_t retVal;
    rtk_uint32 phyData;
...
static rtk_api_ret_t _rtk_port_adminEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    ...
    if (RTK_ENABLED == enable)
    {
        data &= 0xF7FF;
        data |= 0x0200;
    }
    else if (RTK_DISABLED == enable)
    {
        data |= 0x0800;
    }
...
static rtk_api_ret_t _rtk_port_sgmiiLinkStatus_get_uint8(rtk_uint8 port, rtk_uint8 *pSignalDetect, rtk_uint8 *pSync, rtk_uint8 *pLink)
{
    rtk_uint32 ext_id;
    ...
    ext_id = port - 15;
    return rtl8367c_getSdsLinkStatus_uint8(ext_id, pSignalDetect, pSync, pLink);
}
...
{
    return _rtk_port_phyAutoNegoAbility_set(port, pAbility);
}
...
{
    return _rtk_port_phyAutoNegoAbility_get(port, pAbility);
}
...
{
    return _rtk_port_phyForceModeAbility_set(port, pAbility);
}
...
{
    return _rtk_port_phyForceModeAbility_get(port, pAbility);
}
...
{
    return _rtk_port_phyStatus_get(port, pLinkStatus, pSpeed, pDuplex);
}
rtk_api_ret_t rtk_port_phyStatus_get_uint8(uint8_t port, uint8_t *pLinkStatus, uint8_t *pSpeed, uint8_t *pDuplex)
{
    return _rtk_port_phyStatus_get_uint8(port, pLinkStatus, pSpeed, pDuplex);
}
...
{
    return _rtk_port_macForceLink_set(port, pPortability);
}
...
{
    return _rtk_port_macForceLink_get(port, pPortability);
}
...
{
    return _rtk_port_macForceLinkExt_set(port, mode, pPortability);
}
...
{
    return _rtk_port_macForceLinkExt_get(port, pMode, pPortability);
}
...
{
    return _rtk_port_macStatus_get(port, pPortstatus);
}
...
{
    return _rtk_port_macLocalLoopbackEnable_set(port, enable);
}
...
{
    return _rtk_port_macLocalLoopbackEnable_get(port, pEnable);
}
...
{
    return _rtk_port_phyReg_set(port, reg, regData);
}
...
{
    return _rtk_port_phyReg_get(port, reg, pData);
}
...
{
    return _rtk_port_backpressureEnable_set(port, enable);
}
...
{
    return _rtk_port_backpressureEnable_get(port, pEnable);
}
...
{
    return _rtk_port_adminEnable_set(port, enable);
}
...
{
    return _rtk_port_adminEnable_get(port, pEnable);
}
...
{
    return _rtk_port_isolation_set(port, pPortmask);
}
...
{
    return _rtk_port_isolation_get(port, pPortmask);
}
...
{
    return _rtk_port_rgmiiDelayExt_set(port, txDelay, rxDelay);
}
...
{
    return _rtk_port_rgmiiDelayExt_get(port, pTxDelay, pRxDelay);
}
...
{
    return _rtk_port_phyEnableAll_set(enable);
}
...
{
    return _rtk_port_phyEnableAll_get(pEnable);
}
...
{
    return _rtk_port_efid_set(port, efid);
}
...
{
    return _rtk_port_efid_get(port, pEfid);
}
...
{
    return _rtk_port_phyComboPortMedia_set(port, media);
}
...
{
    return _rtk_port_phyComboPortMedia_get(port, pMedia);
}
...
{
    return _rtk_port_rtctEnable_set(pPortmask);
}
...
{
    return _rtk_port_rtctDisable_set(pPortmask);
}
...
{
    return _rtk_port_rtctResult_get(port, pRtctResult);
}
...
{
    return _rtk_port_sds_reset(port);
}
...
{
    return _rtk_port_sgmiiLinkStatus_get(port, pSignalDetect, pSync, pLink);
}
rtk_api_ret_t rtk_port_sgmiiLinkStatus_get_uint8(rtk_uint8 port, rtk_uint8 *pSignalDetect, rtk_uint8 *pSync, rtk_uint8 *pLink)
{
    return _rtk_port_sgmiiLinkStatus_get_uint8(port, pSignalDetect, pSync, pLink);
}
...
{
    return _rtk_port_sgmiiNway_set(port, state);
}
...
{
    return _rtk_port_sgmiiNway_get(port, pState);
}
