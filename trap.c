...
{
    return _rtk_trap_unknownUnicastPktAction_set(port, ucast_action);
}
...
{
    return _rtk_trap_unknownUnicastPktAction_get(port, pUcast_action);
}
...
{
    return _rtk_trap_unknownMacPktAction_set(ucast_action);
}
...
{
    return _rtk_trap_unknownMacPktAction_get(pUcast_action);
}
...
{
    return _rtk_trap_unmatchMacPktAction_set(ucast_action);
}
...
{
    return _rtk_trap_unmatchMacPktAction_get(pUcast_action);
}
...
{
    return _rtk_trap_unmatchMacMoving_set(port, enable);
}
...
{
    return _rtk_trap_unmatchMacMoving_get(port, pEnable);
}
...
{
    return _rtk_trap_unknownMcastPktAction_set(port, type, mcast_action);
}
...
{
    return _rtk_trap_unknownMcastPktAction_get(port, type, pMcast_action);
}
...
{
    return _rtk_trap_lldpEnable_set(enabled);
}
...
{
    return _rtk_trap_lldpEnable_get(pEnabled);
}
...
{
    return _rtk_trap_reasonTrapToCpuPriority_set(type, priority);
}
...
{
    return _rtk_trap_reasonTrapToCpuPriority_get(type, pPriority);
}
...
{
    return _rtk_trap_rmaAction_set(type, rma_action);
}
...
{
    return _rtk_trap_rmaAction_get(type, pRma_action);
}
...
{
    return _rtk_trap_rmaKeepFormat_set(type, enable);
}
...
{
    return _rtk_trap_rmaKeepFormat_get(type, pEnable);
}
